...
siamese_net_weights = torch.load(
        "siamese_network_reid_epoch3.pth", map_location="cuda" if torch.cuda.is_available() else "cpu"
    )
...
while cap.isOpened():
    ...
    for box, label, score in zip(boxes, labels, scores):
        ...
        if score > 0.5:  # Confidence threshold
            ...
            print(f"Frame tensor shape: {object_region_tensor.shape}")
            ...
            print(f"object feaures {object_features}")
            ...
            print("IA M HERE ANGJ<RSKAOEIWRJGn")
