...
from my_utility import parse_gt_file, prepare_data, augment_data, save_gt_data
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), f"fasterrcnn_mots_epoch{epoch+1}.pth")
